...
/*! \file TimeDelayDegeneracyAlgorithm.cpp
...
TimeDelayDegeneracyAlgorithm::~TimeDelayDegeneracyAlgorithm()
{
}

long TimeDelayDegeneracyAlgorithm::Run(list<list<int>> &cliques)
{
...
inline void fillInPandXForRecursiveCallTimeDelayDegeneracy( int vertex, int orderNumber,
                                                   int* vertexSets, int* vertexLookup, 
                                      ...
                                      int size)
{
    ...
    for (i=0;i<size;i++) {
        ...
        // of vertex
        fillInPandXForRecursiveCallTimeDelayDegeneracy( i, vertex, 
...
inline void moveToRTimeDelayDegeneracy( int vertex, 
                               int* vertexSets, int* vertexLookup, 
                               int** neighborsInP, int* numNeighbors,
                               int* pBeginX, int *pBeginD, int *pBeginP, int *pBeginR, 
                               int* pNewBeginX, int *pNewBeginD, int* pNewBeginP, int *pNewBeginR)
...
////    cout << endl;
    ...
    while (iterator < myCandidatesToIterateThrough.size()) {
        ...
        moveToRTimeDelayDegeneracy( vertex, 
                           vertexSets, vertexLookup, 
                           neighborsInP, numNeighbors,
                           &beginX, &beginD, &beginP, &beginR, 
                           &newBeginX, &newBeginD, &newBeginP, &newBeginR);
